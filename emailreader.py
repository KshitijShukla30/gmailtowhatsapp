    ...
    if not creds or not creds.valid:
        if creds and creds.expired and creds.refresh_token:
            try:
                ...
                logging.error("⚠️ Token expired. Please delete 'token.json' and authenticate again.")
                exit()
        else:
...
# Recursive function to extract email body (handles nested structures)
...
if __name__ == "__main__":
    ...
    while True:
        ...
        time.sleep(5)  # Check for new emails every ~16 minutes
